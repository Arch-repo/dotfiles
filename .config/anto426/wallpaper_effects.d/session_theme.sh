...
zen_theme_revision() {
    printf '%s' "${palette_revision:-$(printf '%s' "zen-v2$accent$surface$background$base$base_alt$select" | cksum | awk '{print $1}')}"
}
...
write_zen_theme() {
    ...
    local root profile
    local zen_bg zen_sidebar zen_toolbar zen_panel zen_urlbar zen_hover zen_selected zen_selected_border zen_accent_soft
    ...
    zen_bg="$background"
    zen_sidebar="$(hex_to_css_rgba "$background" 0.96)"
    zen_toolbar="$(hex_to_css_rgba "$base" 0.94)"
    zen_panel="$(hex_to_css_rgba "$popover" 0.98)"
    zen_urlbar="$(hex_to_css_rgba "$base_alt" 0.96)"
    zen_hover="$(hex_to_css_rgba "$select" 0.48)"
    zen_selected="$(hex_to_css_rgba "$select" 0.72)"
    zen_selected_border="$(hex_to_css_rgba "$accent" 0.58)"
    zen_accent_soft="$(hex_to_css_rgba "$accent" 0.30)"
...
:root {
  ...
  --zen-sidebar-background: $zen_sidebar !important;
  --zen-sidebar-text: $foreground !important;
  --zen-sidebar-border: $border !important;
  --zen-toolbar-background: $zen_toolbar !important;
  --zen-toolbar-text: $foreground !important;
  --zen-toolbar-border: $border !important;
  --zen-themed-toolbar-bg: $zen_toolbar !important;
  --zen-themed-toolbar-bg-transparent: $zen_toolbar !important;
  --zen-main-browser-background: $zen_bg !important;
  --zen-main-browser-background-old: $zen_bg !important;
  --zen-main-browser-background-toolbar: $zen_toolbar !important;
  --zen-main-browser-background-toolbar-old: $zen_toolbar !important;
  --zen-background-opacity: 1 !important;
  --zen-dialog-background: $zen_panel !important;
  --zen-urlbar-background: $zen_urlbar !important;
  --lwt-accent-color: $background !important;
  --lwt-text-color: $foreground !important;
  --lwt-sidebar-background-color: $zen_sidebar !important;
  --lwt-sidebar-text-color: $foreground !important;
  --lwt-selected-tab-background-color: $zen_selected !important;
  --toolbar-bgcolor: $zen_toolbar !important;
  --toolbar-color: $foreground !important;
  --toolbar-field-background-color: $zen_urlbar !important;
  --toolbar-field-color: $foreground !important;
  --toolbar-field-border-color: $border !important;
  --arrowpanel-background: $zen_panel !important;
  --arrowpanel-color: $foreground !important;
  --arrowpanel-border-color: $border !important;
  --tab-selected-bgcolor: $zen_selected !important;
  --tab-selected-textcolor: $foreground !important;
  --tab-hover-background-color: $zen_hover !important;
  --urlbar-box-bgcolor: $zen_urlbar !important;
  --urlbar-box-text-color: $foreground !important;
  --button-bgcolor: $zen_hover !important;
  --button-hover-bgcolor: $zen_accent_soft !important;
  --focus-outline-color: $accent !important;
  --toolbarbutton-icon-fill: $foreground !important;
  --toolbarbutton-hover-background: $zen_hover !important;
  --toolbarbutton-active-background: $zen_selected !important;
  --chrome-content-separator-color: $border !important;
  --sidebar-background-color: $zen_sidebar !important;
  --sidebar-text-color: $foreground !important;
  --input-bgcolor: $zen_urlbar !important;
  --input-color: $foreground !important;
  --panel-background: $zen_panel !important;
...
#TabsToolbar,
#nav-bar {
  background-color: $zen_toolbar !important;
...
#tabbrowser-tabs,
#tabbrowser-tabs-container {
  background-color: $zen_sidebar !important;
}

#navigator-toolbox,
#TabsToolbar,
#nav-bar {
  border-color: $(hex_to_css_rgba "$border" 0.52) !important;
}
...
menupopup,
panel {
  background-color: $zen_urlbar !important;
  color: $foreground !important;
...
.zen-workspace-button[active] {
  background-color: $zen_selected !important;
  color: $foreground !important;
  border: 1px solid $zen_selected_border !important;
}
...
toolbarbutton:hover {
  background-color: $zen_hover !important;
}
EOF
